...
public class SearchApi {
    ...
    @GetMapping("/search")
    public ResponseEntity<CMRespDto<?>> search(SearchBookReqDto searchBookReqDto, @AuthenticationPrincipal PrincipalDeteils principalDeteils) {
        if(principalDeteils != null) {
            searchBookReqDto.setUserId(principalDeteils.getUser().getUserId());
        }
